	...
	*b=10;
	...
	// Este fichero contiene 64 bits por página lógica e informa sobre el PFN
 	...
 	if ( infile != NULL )
 	{
      	...
      	{
           	char *p, *pf, *tipus ; // p = página inicial, pf = página final
        	...
        	*/
        	  ...
        	  tipus = strtok(NULL,""); // El funcionamento de strtok necesita NULL en la siguiente llamada
            if (strstr(tipus, "stack") != NULL) { //busca stack o heap en la línea p
